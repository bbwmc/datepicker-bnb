<template>
  ...
  >
    <a
      ...
      v-if="isOpen"
      class="-hide-on-desktop clear--btn"
      >Clear dates</a
    >
    <div class="datepicker__close-button -hide-on-desktop" v-if="isOpen" @click="hideDatepicker">
      ＋
    </div>
    <div
      ...
      <div class="datepicker__inner">
        ...
        <div v-if="screenSize !== 'desktop' && isOpen">
          <div class="datepicker__months" id="swiperWrapper">
            ...
            <!-- <button @click="apply" class="apply--button" type="button">APPLY</button> -->
...
export default {
  ...
  props: {
    currentDateStyle: {
      default: () => ({ border: "1px solid #00ccff" })
    },
    value: {
      type: String
    },
  ...
  methods: {
    ...
    renderNextMonth: function throttleRenderNextMonth() {
...
.datepicker {
  ...
  .datepicker__dummy-wrapper--is-active {
    border-top: 0.5px solid $primary-color !important;
  ...
  button.next--mobile {
    ...
    &:after {
      background: transparent url("./plane_icon.svg") no-repeat 100%/40px !important;
